...
class CategoryModel extends Model {
    ...
    protected $allowedFields = ['id','cat_userid', 'name', 'desc', 'start_time', 'end_time', 'com_interval', 'status', 'result_type','result_mode','com_showresult','com_working','com_order','com_created','com_template'];
    protected $db;
