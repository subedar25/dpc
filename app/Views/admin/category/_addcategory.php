                                ...
                                <div  class=" col-lg-12">
                                    ...
                                    <div class="row  form-group">
                                        ...
                                        <div style="margin-bottom:6px;">
                                            <input type="checkbox" class="workingday-select-all" id="workingday_select_all_add">
                                            <label for="workingday_select_all_add" style="margin-left:4px;">Select All</label>
                                        </div>
                                        <table width="100%" >
                                            <tr>
                                                <td><input type="checkbox" class="workingday" id="add_working_mon" name="workingday[]" value="MON" > </td>
                                                <td><label for="add_working_mon">Monday</label></td>
                                                <td><input type="checkbox" class="workingday" id="add_working_tue" name="workingday[]" value="TUE" > </td>
                                                <td><label for="add_working_tue">Tuesday</label></td>
                                                <td><input type="checkbox" class="workingday" id="add_working_wed" name="workingday[]" value="WED" > </td>
                                                <td><label for="add_working_wed">Wednesday</label></td>
                                            </tr>
                                            <tr>
                                                
                                                <td><input type="checkbox" class="workingday" id="add_working_thu" name="workingday[]" value="THU" > </td>
                                                <td><label for="add_working_thu">Thursday</label></td>
                                                <td><input type="checkbox" class="workingday" id="add_working_fri" name="workingday[]" value="FRI" > </td>
                                                <td><label for="add_working_fri">Friday</label></td>
                                                <td><input type="checkbox" class="workingday" id="add_working_sat" name="workingday[]" value="SAT" > </td>
                                                <td><label for="add_working_sat">Saturday</label></td>
                                            </tr>
                                            <tr>
                                                
                                                <td><input type="checkbox" class="workingday" id="add_working_sun" name="workingday[]" value="SUN" > </td>
                                                <td><label for="add_working_sun">Sunday</label></td>
                                                <td> </td>
                                                <td> </td>
                                                <td> </td>
                                                <td> </td>
...
$(function () {
    syncWorkingSelectAll($('#addcategoryform'));
});
</script>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
