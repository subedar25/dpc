                                    ...
                                    <tbody>
                                        ...
                                        <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" onclick="getMultipleEdit('<?php echo $kdata->com_id; ?>');" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editmultipleresult">Edit</a>

                                              <a href="<?php echo site_url('delmulresult?id=' . $kdata->com_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
