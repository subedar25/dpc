...
<!--                <div class="col-sm-6">
            ...
            <?php $showcheckbox =0;
             echo view('admin/company/_searchform',array("searchArray"=>$searchArray)); ?>
                                ...
                                <table class="table table-hover table-centered table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php } ?>
                                            ...
                                            <td><?php echo date("h:i A", strtotime($kdata->com_starttime));; ?></td>
                                            <td><?php echo date("h:i A", strtotime($kdata->com_endtime)); ?></td>
                                            <td><?php echo $kdata->com_date; ?></td>
                                           
                                            <td>
                                              
                                                <a href="#" onclick="getOrderEdit('<?php echo $kdata->com_id; ?>');" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editorder">Edit</a>

                                              <a href="<?php echo site_url('delresult?id=' . $kdata->com_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
...
<?php echo view('admin/company/_editresult'); ?>
