    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 ">
                <?php if (count($historyData)) { ?>
                    <div>
                        ...
                        <div align="center" style="padding-top:5px; padding-bottom: 5px;" id="posts">
                         ...
                         <?php //echo view('user/_viewallresultsingle', array('historyData' => $historyData)); ?>
                ...
                <div class="row">
                    <a href="javascript:javascript:history.go(-1)" class="btn btn-info"> <i class="fa fa-arrow-circle-left"></i> <b>Back</b></a> |
