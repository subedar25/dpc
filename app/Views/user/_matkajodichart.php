<div class="sky-23">
    ...
    <a href="<?php echo site_url('matka-jodi-count-chart'); ?>">Matka Jodi Count Chart</a>
    <a href="<?php echo site_url('fix-open-to-close-by-date'); ?>">Dhanvarsha Daily Fix Open To Close</a>
