            ...
            ?>
                <?php foreach ($liveresultData as $resultdata) { ?>
                    ...
                    <div style=" border-bottom: 1px solid red;padding-bottom: 11px;">
                        ...
                        $description = $resultdata['description'] ? $resultdata['description'] : ($resultdata['com_desc'] ? $resultdata['com_desc'] : "");
                        ?>
                                ...
                                <?php } else { ?>
                                    <?php if ($resultdata['com_open'] || $show_old_result) { ?>
                                        ...
                                        if ($resLast) {
                                            ...
                                            $description = $resultdata['description'] ? $resultdata['description'] : ($resLast['com_desc'] ? $resLast['com_desc'] : "");
                                        ?>
