...
<?php //echo view('user/rightpanel'); ?>
	...
	<!-- <script src="<?php echo base_url('admin/libs/dropzone/min/dropzone.min.js'); ?>"></script> -->
	...
	<script src="<?php echo base_url('js/compressor.js'); ?>"></script>
